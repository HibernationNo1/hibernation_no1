...
from sub_module.mmdet.utils import auto_scale_lr
...
class DefaultOptimizerConstructor:
    ...
    def __init__(self,
        ...
        if not isinstance(optimizer_cfg, dict):
            raise TypeError('optimizer_cfg should be a dict, but got {type(optimizer_cfg)}')
    ...
    def _validate_cfg(self) :
        ...
        if ('bias_decay_mult' in self.paramwise_cfg
            ...
            if self.base_wd is None:    raise ValueError('base_wd should not be None')
