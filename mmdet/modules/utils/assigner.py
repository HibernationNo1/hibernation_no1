...
class MaxIoUAssigner(BaseAssigner):
    ...
    def __init__(self,
        ...
        iou_calculator_cfg = iou_calculator.copy()
        iou_calculator_type = iou_calculator_cfg.pop('type')
        if iou_calculator_type == 'BboxOverlaps2D':
            
            self.iou_calculator = BboxOverlaps2D(**iou_calculator_cfg)
        else:
            raise TypeError(f"`iou_calculator` only implemented 'BboxOverlaps2D'")
